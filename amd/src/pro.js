...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var moodlescriptpro = {
        ...
        component: 'tool_moodlescript',
        shortcomponent: 'tool_moodlescript',
        componentpath: 'admin/tool/moodlescript',

        init: function() {

            var licensekeyid = '#id_s_' + moodlescriptpro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + moodlescriptpro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = moodlescriptpro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + moodlescriptpro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + moodlescriptpro.component + '_licenseprovider').val();
